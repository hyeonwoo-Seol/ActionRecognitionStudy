...
PROB = 0.8 # -> 0.8데이터 증강 확률. 80% 확률로 증강을 '안'한다.
SPATIAL_KEEP_RATE = 0.6 # 공간적 어텐션에서 '중요 관절'로 유지할 비율
...
ADAMW_WEIGHT_DECAY = 0.01 # -> 0.01AdamW weight decay , L2 정규화의 강도 설정
PATIENCE = 10 # 조기종료 변수
LABEL_SMOOTHING = 0.05 # -> 0.05 Loss Function CrossEntropy의 label smoothing
DROPOUT = 0.2 # -> 0.2 dropout
ETA_MIN = 1e-6
