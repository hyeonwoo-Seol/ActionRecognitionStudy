...
PROB = 0.1       # -> 데이터 증강 확률. 60% 확률로 증강을 '안'한다.
NUM_SUBJECTS = 40
...
DROPOUT = 0.418
ETA_MIN = 1e-6
T_0 = 10    # n에폭마다 학습률이 최대치로 초기화된다. 현재는 사용하지 않기 위해 100으로 설정했다.
...
FAST_DIMS = [64, 64, 64, 64]       # Fast: 가볍게
SLOW_DIMS = [64, 64, 128, 128]    # Slow: 무겁게, 이전 값: [128, 128, 256]
